...
from extract_image import convert_pdf_to_jpg, show_image
import cv2
import keras_ocr
import math


image_array = convert_pdf_to_jpg('data/pdf/1_pic.pdf', 'poppler-23.08.0/Library/bin', 'data/jpg')

# convert BGR to GRAY
gray = cv2.cvtColor(image_array[0], cv2.COLOR_BGR2GRAY)    # cv2.COLOR_BGR2GRAY
...
img_text_removed = inpaint_text("data/jpg/page0.jpg", pipeline)
